      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto max-w-screen-xl px-4 py-24 text-center md:py-32">
          ...
          <h1 className="mx-auto max-w-3xl text-4xl font-bold tracking-tight md:text-5xl">
            프로덕션 레디 <span className="text-primary">스타터킷</span>
          </h1>
          <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg">
            이 프로젝트는 Next.js 16, TypeScript, shadcn/ui를 기반으로 한 모던
            웹 개발 스타터킷입니다. 복잡한 초기 설정 없이 바로 개발에 집중할 수
            있도록 설계되었습니다.
          </p>
        </section>
          ...
          <div className="container mx-auto max-w-screen-xl px-4">
            <div className="mb-12 text-center">
              ...
              <p className="text-muted-foreground mt-3">
                프로덕션 환경에서 바로 사용할 수 있는 기능들이 포함되어
                있습니다.
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto max-w-screen-xl px-4">
            <div className="mb-12 text-center">
              ...
              <p className="text-muted-foreground mt-3">
                업계에서 널리 사용되는 안정적이고 현대적인 기술 스택을
                채택했습니다.
              </p>
            </div>
        ...
        <section className="bg-muted/40 border-t py-20">
          <div className="container mx-auto max-w-screen-xl px-4">
            <div className="mb-12 text-center">
              <Badge variant="outline" className="mb-3">
                <Users className="mr-1 size-3" />팀 소개
              </Badge>
              <h2 className="text-3xl font-bold tracking-tight">
                함께 만들어갑니다
              </h2>
                  ...
                  >
                    <CardHeader>
                      <div className="bg-primary/10 mx-auto mb-3 flex size-16 items-center justify-center rounded-full">
                        <MemberIcon className="text-primary size-7" />
                      </div>
